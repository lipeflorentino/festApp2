...
export default class AdminAlimentacao extends Component {
  constructor(props){
    super(props)
    ...
    this.cadastrarAlimentacao = this.cadastrarAlimentacao.bind(this);
...
cadastrarAlimentacao(e){
    ...
    if(this.state.nome != '' && this.state.descricao != '' && this.state.mapaUrl != '' && this.state.imageUrl != '' && this.state.endereco != '' && this.state.email != '' && this.state.telefone != '' && this.state.instrucoes != ''){
        ...
        let alimentacao = firebase.database().ref("alimentacao");
        let chave = alimentacao.push().key;
        console.log('inserindo...')
        alimentacao.child(chave).set({ 
...
render() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title="Novo local" onPress={this.cadastrarAlimentacao}></Button>
        </View>
    );
